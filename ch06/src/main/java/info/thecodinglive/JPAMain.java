...
import info.thecodinglive.repository.UserRepositoryImpl;
...
public class JPAMain {
        public static void main(String[] args) {
                ...
                UserRepositoryImpl repoimp = new UserRepositoryImpl(UserEntity.class);
                ...
                System.out.println( repoimp.maxUserAge());
